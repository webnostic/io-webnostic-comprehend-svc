package io.webnostic.comprehend.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("ComprehendService");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("ComprehendService");
        ...
        config.getMapConfigs().put("io.webnostic.comprehend.domain.*", initializeDomainMapConfig(jHipsterProperties));
